<div class="_card-kerugian flex justify-between shadow p-[20px] w-full h-full bg-white rounded-[20px]">
    <div class="_heading flex flex-col justify-between">
        <div>
            ...
            <p class="text-[32px] font-medium font-poppins">Rp. 443M</p>
            <p class="text-[14px] mt-[10px] rounded-full w-fit p-[5px] text-center text-[#1ED0A6] bg-[#D6FFF3]">
                {{ date('Y') }}</p>
        </div>
        <div class="items-center gap-[10px] w-full"><a href=""
